...
export const seedBuilds: PartyBuild[] = [
  build({
    ...
    title: "+55–95% Fishing Items • 12–35% Slower Gauge Loss",
    category: "Fishing",
    summary: "",
  ...
  build({
    ...
    title: "35–45% + 45–55% Alpha Egg • 50–75% Extra Egg",
    category: "Breeding",
    summary: "",
  ...
  build({
    ...
    title: "+40–80% Player Attack • +25–40% Dark Weak-Point Damage",
    category: "Combat",
    summary: "",
  ...
  build({
    ...
    title: "+300–600 Carry Capacity • 80–100% Lighter Stone",
  ...
  build({
    ...
    title: "+40–80% Water Pal Drops • 10–50% Sphere Save",
    category: "Farming",
    summary: "",
